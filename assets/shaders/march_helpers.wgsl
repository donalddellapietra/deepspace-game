...
// Cell-pack helpers, path-mask conservative cull, and the
// walker-probe writer. Shared utilities used by both the
// Cartesian and sphere DDAs. No dependencies beyond bindings.
