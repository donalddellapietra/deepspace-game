...
fn march_cartesian(
    ...
    loop {
        ...
        if tag == 1u {
            ...
            // Rotated45Y dispatch: when the child node carries
            // `NodeKind::Rotated45Y`, transform the ray into the
            // rotated local [0, 3)³ frame and run a standard
            // cartesian DDA inside, then map the hit back to world.
            // Subtree can be any cartesian depth — rotation is
