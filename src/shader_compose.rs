...
const SOURCES: &[(&str, &str)] = &[
    ...
    ("df64.wgsl",      include_str!("../assets/shaders/df64.wgsl")),
    ("march_helpers.wgsl",       include_str!("../assets/shaders/march_helpers.wgsl")),
    ("march_entity.wgsl",        include_str!("../assets/shaders/march_entity.wgsl")),
    ("march_cartesian.wgsl",     include_str!("../assets/shaders/march_cartesian.wgsl")),
    ("march_sphere_pack.wgsl",   include_str!("../assets/shaders/march_sphere_pack.wgsl")),
    ("march_sphere_hit.wgsl",    include_str!("../assets/shaders/march_sphere_hit.wgsl")),
    ("march_sphere_anchor.wgsl", include_str!("../assets/shaders/march_sphere_anchor.wgsl")),
    ("march_sphere_uv.wgsl",     include_str!("../assets/shaders/march_sphere_uv.wgsl")),
    ("march.wgsl",     include_str!("../assets/shaders/march.wgsl")),
    ("march_debug.wgsl", include_str!("../assets/shaders/march_debug.wgsl")),
