...
const SOURCES: &[(&str, &str)] = &[
    ...
    ("uvsphere.wgsl",  include_str!("../assets/shaders/uvsphere.wgsl")),
    ("uvsphere/types.wgsl",         include_str!("../assets/shaders/uvsphere/types.wgsl")),
    ("uvsphere/basis.wgsl",         include_str!("../assets/shaders/uvsphere/basis.wgsl")),
    ("uvsphere/cell.wgsl",          include_str!("../assets/shaders/uvsphere/cell.wgsl")),
    ("uvsphere/march_root.wgsl",    include_str!("../assets/shaders/uvsphere/march_root.wgsl")),
    ("uvsphere/march_subcell.wgsl", include_str!("../assets/shaders/uvsphere/march_subcell.wgsl")),
