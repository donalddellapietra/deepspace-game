...
const SOURCES: &[(&str, &str)] = &[
    ...
    ("march_slab.wgsl", include_str!("../assets/shaders/march_slab.wgsl")),
    ("march_tangent_cube.wgsl", include_str!("../assets/shaders/march_tangent_cube.wgsl")),
    ("march_cartesian.wgsl", include_str!("../assets/shaders/march_cartesian.wgsl")),
    ("march_wrapped_planet.wgsl", include_str!("../assets/shaders/march_wrapped_planet.wgsl")),
    ("march_uv_ring.wgsl", include_str!("../assets/shaders/march_uv_ring.wgsl")),
