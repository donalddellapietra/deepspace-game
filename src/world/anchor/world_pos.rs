...
impl WorldPos {
    ...
    /// (rotated, inscribed-shrunk) into the parent-of-TB Cartesian
    /// frame BEFORE the standard `(slot_offset + offset) / 3`
    /// rescaling. `tb_scale ≤ 1` keeps the result inside `[0, 1)³`.
