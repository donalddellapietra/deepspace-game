...
impl App {
    ...
    /// Face-subtree edit depth. Retained as a seam for coordinate
    /// systems that carry a logically deeper layer than the linear
    /// render frame; for Cartesian this equals `edit_depth`.
