...
impl App {
    ...
    pub(in crate::app) fn upload_tree_lod(&mut self) {
        ...
        // View-tree integration disabled — startup hangs even with
        // uniform-flatten + sub-pixel + no-change short-circuits.
        // Something else is wrong; needs profiling. Module stays.
