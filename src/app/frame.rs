...
pub struct ActiveFrame {
    ...
    /// identical to `render_path`. Kept as a separate field to leave
    /// room for coordinate systems that carry a deeper logical layer
    /// while the linear render root stays at a containing cell.
