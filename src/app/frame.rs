...
pub struct ActiveFrame {
    ...
    /// R^T rotation center in frame-local [0,3)³. Non-zero when
    /// the frame path crossed a TangentBlock. The shader applies
    /// full R^T around this point at frame entry so inside matches
    /// the outside TB dispatch.
    pub tb_center: [f32; 3],
}
