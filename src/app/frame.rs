...
pub struct ActiveFrame {
    ...
    /// Logical interaction/render layer path. Equal to `render_path`
    /// in the all-Cartesian world.
...
/// Resolve the active frame at the requested depth.
...
pub fn with_render_margin(
    ...
    // Cartesian shell architecture: the render frame IS the
    // innermost shell root. The shader pops outward via the ribbon
    // for coarser context. No render_margin needed — each shell has
    // a bounded depth budget.
