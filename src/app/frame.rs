...
//!
//! The previous `SphereSub` kind (linearized face-subtree local
//! frame) is gone. Deep-m rendering goes through the body march
//! with walker precision preserved via integer slot ratios.
//!
