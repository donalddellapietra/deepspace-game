...
use crate::world::view::{
    bevy_from_position, cell_size_at_layer, norm_for_layer, position_to_leaf_coord,
...
pub fn spawn_anchor() -> WorldAnchor {
    WorldAnchor {
        ...
        // Start at leaf layer (MAX_LAYER), norm = scale_for_layer(MAX_LAYER) = 1.0
...
pub fn sync_anchor_to_player(
    ...
    // Entity scale compensates: scale = scale_for_layer(target) / norm.
