...
impl Renderer {
    ...
    pub(super) fn write_uniforms(&self) {
        ...
        let uniforms = GpuUniforms {
            ...
            subframe_lat_lon: self.subframe_lat_lon,
            slab_dims: self.slab_dims,
            subframe_r: self.subframe_r,
            subframe_wp_dims: self.subframe_wp_dims,
            node_lat_lon: self.node_lat_lon,
            node_r: self.node_r,
            proto_target_cell: self.proto_target_cell,
            proto_target_lat_lon: self.proto_target_lat_lon,
            proto_target_r: self.proto_target_r,
            proto_sub_node: self.proto_sub_node,
            proto_sub_lat_lon: self.proto_sub_lat_lon,
            proto_sub_r: self.proto_sub_r,
...
pub(super) fn make_bind_group(
    ...
    device.create_bind_group(&wgpu::BindGroupDescriptor {
        ...
        entries: &[
            ...
            wgpu::BindGroupEntry { binding: 11, resource: walker_probe.as_entire_binding() },
        ],
    })
}
