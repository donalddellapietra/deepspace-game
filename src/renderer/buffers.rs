...
impl Renderer {
    ...
    pub(super) fn write_uniforms(&self) {
        ...
        let uniforms = GpuUniforms {
            ...
            uv_body_params: self.uv_body_params,
            uv_subcell_body_idx: self.uv_subcell_body_idx,
            uv_subcell_origin: self.uv_subcell_origin,
            uv_subcell_size: self.uv_subcell_size,
