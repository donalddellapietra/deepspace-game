...
#
# Expected result on current HEAD (occupancy-stack-slim):
#   step frames  (every 5):  pack_ms ≈ 85-92 ms, total ≈ 90 ms
#   wait frames:             pack_ms = 0,        reused=1
#   ~worst-case total_ms: ~100 ms (10 FPS spike)
#
